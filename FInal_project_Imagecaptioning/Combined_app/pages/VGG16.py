...
def main():
    ...
    # Title
    st.markdown("<div class='title'>Multilingual  Image Captioning and Text-to-Speech</div>", unsafe_allow_html=True)
    ...
    with col2:
        st.image("images/vgg16.png", use_column_width=True, caption="Welcome to my page")
